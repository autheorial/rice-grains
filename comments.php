...
<table><tr width="auto"><td><?php echo get_avatar( $comment, $size = '100', $default = 'http://rice.hugs.nu/images/default2.png' ); ?></td>

<td><div style="padding:10px; height:100;">
 <a href="<?php comment_author_url(); ?>" class="author">
   <?php comment_author(); ?>
 </a> <br>
   <font face="georgia"><?php comment_date('F jS, Y') ?>
   at <?php comment_time() ?>
   <a href="#comment-<?php comment_ID() ?>">+</a></font></div>
</div></td></tr></table>
...
<h2>
<?php comment_form_title( 'Comment!', 'Comment to %s!' ); ?>
</h2>
